...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Visits.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Visits.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_visits())
			{
				...
				Template::redirect(SITE_AREA .'/reports/visits');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/visits');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Visits.Reports.Edit');
		...
		{
			$this->auth->restrict('Visits.Reports.Delete');
