<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<?php if ($this->auth->has_permission('Visits.Reports.Delete') && isset($records) && is_array($records) && count($records)) : ?>
			...
			<tfoot>
				<?php if ($this->auth->has_permission('Visits.Reports.Delete')) : ?>
				<tr>
					<td colspan="5">
			...
			<?php foreach ($records as $record) : ?>
				...
				<?php if ($this->auth->has_permission('Visits.Reports.Edit')) : ?>
				<td><?php echo anchor(SITE_AREA .'/reports/visits/edit/'. $record->vid, '<i class="icon-pencil">&nbsp;</i>' .  $record->visits_pid) ?></td>
				<?php else: ?>
