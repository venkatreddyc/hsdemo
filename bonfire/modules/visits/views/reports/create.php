...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
        ...
        <div class="control-group <?php echo form_error('visits_date') ? 'error' : ''; ?>">
            ...
            <div class='controls'>
        <input id="visits_date" type="text" name="visits_date"  value="<?php echo date("Y-m-d"); ?>"  />
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="save" class="btn btn-primary" value="Create visits" />
            or <?php echo anchor(SITE_AREA .'/reports/visits', lang('visits_cancel'), 'class="btn btn-warning"'); ?>
