<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<?php if ($this->auth->has_permission('VisitPhotos.Content.Delete') && isset($records) && is_array($records) && count($records)) : ?>
			...
			<tfoot>
				<?php if ($this->auth->has_permission('VisitPhotos.Content.Delete')) : ?>
				<tr>
					<td colspan="4">
			...
			<?php foreach ($records as $record) : ?>
				...
				<?php if ($this->auth->has_permission('VisitPhotos.Content.Edit')) : ?>
				<td><?php echo anchor(SITE_AREA .'/content/visitphotos/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>' .  $record->visitphotos_property_id) ?></td>
				<?php else: ?>
