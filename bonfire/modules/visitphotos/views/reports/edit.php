...
<?php $options = array(
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="save" class="btn btn-primary" value="Edit VisitPhotos" />
            or <?php echo anchor(SITE_AREA .'/reports/visitphotos', lang('visitphotos_cancel'), 'class="btn btn-warning"'); ?>
            

    <?php if ($this->auth->has_permission('VisitPhotos.Reports.Delete')) : ?>

            or <button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php echo lang('visitphotos_delete_confirm'); ?>')">
            <i class="icon-trash icon-white">&nbsp;</i>&nbsp;<?php echo lang('visitphotos_delete_record'); ?>
            </button>
