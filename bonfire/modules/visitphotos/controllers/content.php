...
class content extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('VisitPhotos.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('VisitPhotos.Content.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_visitphotos())
			{
				...
				Template::redirect(SITE_AREA .'/content/visitphotos');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/content/visitphotos');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('VisitPhotos.Content.Edit');
		...
		{
			$this->auth->restrict('VisitPhotos.Content.Delete');
